...
public class ProcessManager {
    ...
    public static String typePartner;
    ...
    public static void start() {
        try {
            ...
            typePartner = DataConfig.getStringProperties("typePartner");
            backDay = DataConfig.getIntProperties("backDay");
            interval = DataConfig.getLongProperties("interval", 3600 * 24);
            startDate = DataConfig.getIntProperties("startDate", -1);
