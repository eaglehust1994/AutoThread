...
import static com.viettel.ctct.merHistory.ProcessManager.connectTimeout;
import static com.viettel.ctct.merHistory.ProcessManager.database;
import static com.viettel.ctct.merHistory.ProcessManager.hour;
import static com.viettel.ctct.merHistory.ProcessManager.interval;
import static com.viettel.ctct.merHistory.ProcessManager.maxBatchSize;
import static com.viettel.ctct.merHistory.ProcessManager.minute;
import static com.viettel.ctct.merHistory.ProcessManager.requestTimeout;
import static com.viettel.ctct.merHistory.ProcessManager.startDateContract;
...
public class ProcessManager {
    ...
    public static void start() {
        try {
            ...
            interval = DataConfig.getLongProperties("interval", 3600 * 24);//chu ki 
            startDateContract = DataConfig.getIntProperties("startDateContract", -1);//thoi gian bat dau cau sql
            maxBatchSize = DataConfig.getLongProperties("maxBatchSize", 1000);// khi insert chia nho 1000 ban ghi 1 lan
