...
import com.viettel.kpi.SendEmailProcessMonthly.EmailSendFrom;
import com.viettel.kpi.SendEmailProcessMonthly.MscServer;
import com.viettel.kpi.SendEmailProcessMonthly.MyDbTask;
                    ...
                    if (isFile == 1) {
                        ...
                        for (String filename : lstFileName) {
                            try {
                                ...
                                String fileWeek = filename + "_" + thang + ".xlsx";
