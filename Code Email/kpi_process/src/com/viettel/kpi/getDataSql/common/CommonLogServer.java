...
public class CommonLogServer {
    ...
    public CommonLogServer(String ip, String driver, String url, String userName, String password) {
        this.ip = ip;
        this.driver = driver;
        this.url = url;
    ...
    public CommonLogServer(long logServerId, String logServerName, String protocol, String ip, String driver, String url, String userName, String password, String vendor, int status, Integer port) {
