...
public class ProcessManager extends ZkProcess {
    ...
    public static void startManager() {
        try {
            ...
            idCNVT = DataConfig.getIntProperties("idCNVT");
            ip = DataConfig.getStringProperties("ip");
            username = DataConfig.getStringProperties("username");
            password = DataConfig.getStringProperties("password");
            url = DataConfig.getStringProperties("url");

            process = new ProcessThreadService(hourRun,ip,username,password,url,idCNVT);
