...
public class LogServer {
    ...
    public LogServer(String logServerId, String name, int serverTypeId, String url, String ip, int port, String username, String password, String vendor, String protocol, String driver, int enable, String module, String areaCode) {
        this.logServerId = logServerId;
        this.name = name;
        this.serverTypeId = serverTypeId;
        this.url = url;
