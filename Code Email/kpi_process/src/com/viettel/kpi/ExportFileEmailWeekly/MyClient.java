...
//            sql.append(" type_report,is_day_run,type");
//            sql.append(" FROM common_map_email a");
//            sql.append(" where end_time_run= trunc(sysdate-1) and type=2");
            //            hoanm1_add_09062016
            sql.append(" SELECT a.function_code,a.type_sms_email_code,a.body_email,a.fomat_body_email,a.is_file,"
                    ...
                    + " cata_email b where a.type_report=b.type_report and a.type=b.type and b.type=2");
//            hoanm1_add_09062016
...
//                mapInfomationConfig.put(emailConfigForm.getFunctionCode(), lstEmailConfig);
                mapInfomationConfig.put(emailConfigForm.getFunctionCode() + emailConfigForm.getEmail() + emailConfigForm.getHour_run() + emailConfigForm.getDay_run(), lstEmailConfig);
                count++;
            }
