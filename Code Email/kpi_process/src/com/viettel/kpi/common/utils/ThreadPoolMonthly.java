...
import com.viettel.kpi.SendEmailProcessMonthly.SocketThread;
 ...
 * @author Khiemvk
 */
public class ThreadPoolMonthly {
    
    private static final Logger logger = Logger.getLogger(ThreadPoolMonthly.class.getName());
    List<SocketThread> threadList = new ArrayList<SocketThread>();
    List<Boolean> threadIsUseList = new ArrayList<Boolean>();
    int threadMin = 1;
    int threadMax;

    public ThreadPoolMonthly(int threadMax) {       
